...

{
    function fixTable() {
        ...
        const firstRow = table.querySelector('.indexhead');
        ...
        rows.forEach((row) => {
            ...
            const image = iconColumn.querySelector('img');
    ...
    function addSearch() {
        ...
        const sortColumns = Array.from(document.querySelectorAll('.indexhead a'));
        const nameColumns = Array.from(document.querySelectorAll('.tabela .indexcolname'));
